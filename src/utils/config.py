...
model_config = {
    ...
    # AM (RP+SS), pft=1 — compact_config mirrors compact-qwen3_5-4b-am-rpss-pft1 verbatim.
    # Gemma sampling from gemma-4-E4B-it generation_config (temp 1.0/top_p 0.95/top_k 64, no presence_penalty).
    "gemma4-e4b-am-rpss-pft1": {
        "model_name": "compact-gemma4-e4b",
        "base_url": _COMPACT_BASE_URL,
        "api_key": "unused",
        "is_claude_thinking": False,
    ...
    # AM (RP+SS), pft=2 — compact_config mirrors compact-qwen3_5-4b-am-rpss-pft2 verbatim.
    # Gemma sampling from gemma-4-E4B-it generation_config (temp 1.0/top_p 0.95/top_k 64, no presence_penalty).
    "gemma4-e4b-am-rpss-pft2": {
        "model_name": "compact-gemma4-e4b",
        "base_url": _COMPACT_BASE_URL,
        "api_key": "unused",
        "is_claude_thinking": False,
    ...
    # TE (self_study), pft=0 — compact_config mirrors compact-qwen3_5-4b-boundary-te-pft0 verbatim.
    # Gemma sampling from gemma-4-E4B-it generation_config (temp 1.0/top_p 0.95/top_k 64, no presence_penalty).
    "gemma4-e4b-boundary-te-pft0": {
        "model_name": "compact-gemma4-e4b",
        "base_url": _COMPACT_BASE_URL,
        "api_key": "unused",
        "is_claude_thinking": False,
    ...
    # TE (self_study), pft=2 (te-ss lineage, ibp=False) — compact_config mirrors compact-qwen3_5-4b-te-ss-pft5-r0.2 verbatim (override: {'proxy_future_turns': 2}).
    # Gemma sampling from gemma-4-E4B-it generation_config (temp 1.0/top_p 0.95/top_k 64, no presence_penalty).
    "gemma4-e4b-te-ss-pft2": {
        "model_name": "compact-gemma4-e4b",
        "base_url": _COMPACT_BASE_URL,
        "api_key": "unused",
        "is_claude_thinking": False,
    ...
    # TE (self_study), pft=5 — compact_config mirrors compact-qwen3_5-4b-te-ss-pft5-r0.2 verbatim.
    # Gemma sampling from gemma-4-E4B-it generation_config (temp 1.0/top_p 0.95/top_k 64, no presence_penalty).
    "gemma4-e4b-te-ss-pft5-r0.2": {
        "model_name": "compact-gemma4-e4b",
        "base_url": _COMPACT_BASE_URL,
        "api_key": "unused",
        "is_claude_thinking": False,
    ...
    # TE (self_study), pft=5, dynamic — compact_config mirrors compact-qwen3_5-4b-te-ss-dynamic-pft5-r0.2 verbatim.
    # Gemma sampling from gemma-4-E4B-it generation_config (temp 1.0/top_p 0.95/top_k 64, no presence_penalty).
    "gemma4-e4b-te-ss-dynamic-pft5-r0.2": {
        "model_name": "compact-gemma4-e4b",
        "base_url": _COMPACT_BASE_URL,
        "api_key": "unused",
        "is_claude_thinking": False,
